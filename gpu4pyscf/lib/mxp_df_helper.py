...
def cuda_jk_build(
    ...
    libmxp_df_helper.get_gemmul8_workspace_bytes.restype = ctypes.c_size_t
    gemmul8_workspace_bytes = libmxp_df_helper.get_gemmul8_workspace_bytes(
        ctypes.c_int(naux),
        ctypes.c_int(nao),
        ctypes.c_int(nocc),
    ...
    workbuf_bytes += gemmul8_workspace_bytes  # GEMMUL8 workspace
    ...
    err = libmxp_df_helper.DF_JK_build(
        ...
        ctypes.c_size_t(gemmul8_workspace_bytes),

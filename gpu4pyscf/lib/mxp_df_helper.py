...
non_flagship_gpu_mxp_strategies = {
    ...
    1: ('FP64', 1, 47),  # cuBLAS emulated FP64, 47 bits accuracy (~7e-15)
    2: ('FP64', 1, 39),  # cuBLAS emulated FP64, 39 bits accuracy (~2e-12)
    3: ('FP64', 1, 31),  # cuBLAS emulated FP64, 31 bits accuracy (~4e-10)
    4: ('FP64', 1, 23),  # cuBLAS emulated FP64, 23 bits accuracy (~2e-7)
}
